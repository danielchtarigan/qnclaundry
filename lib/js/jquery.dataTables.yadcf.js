...
* date_format
				...
				Possible values:	dd/mm/yyyy / dd/mm/yyyy (eventually I replace yyyy into yy for jquery datepicker)
		...
		for (columnsArrIndex = 0; columnsArrIndex < filtersOptions.length; columnsArrIndex++) {
			...
			if (columnsObj.filter_default_label === undefined) {
				if (columnsObj.filter_type === "select" || columnsObj.filter_type === 'custom_func') {
					columnsObj.filter_default_label = "pilih";
				} else if (columnsObj.filter_type === "multi_select" || columnsObj.filter_type === 'multi_select_custom_func') {
					columnsObj.filter_default_label = "pilih";
				} else if (columnsObj.filter_type === "auto_complete" || columnsObj.filter_type === "text") {
					columnsObj.filter_default_label = 'Type to filter';
				} else if (columnsObj.filter_type === "range_number" || columnsObj.filter_type === "range_date") {
					columnsObj.filter_default_label = ["dari", "ke"];
				} else if (columnsObj.filter_type === "date") {
					columnsObj.filter_default_label = "Pilih Tgl";
				}
			}
