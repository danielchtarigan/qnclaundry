...
<html>
<head>
	<title>Document PO</title>
	<link href="../bootstrap/css/bootstrap.min.css" rel="stylesheet">
</head>
<body onload="window.print()" style="margin-left: 15px; margin-right: 15px; margin-top: 20px">
	<?php

	$hasil = '';
	$nomor = $_GET['id'];
	$sql = $con->query("SELECT * FROM purchase_order_data a, supplier b WHERE a.vendor=b.nama_supplier AND nomor_po='$nomor'");
		...
		'<img src="../../logo.png" width="8%">
		 ...
		 <div class="row">
			...
			';
						...
						$sql = $con->query("SELECT * FROM purchase_order_data WHERE nomor_po='$nomor' ");	
						while($data = $sql->fetch_array()){
							...
							$hasil .= '
								<tr>
									...
									<td class="unit_price" data-id4="'.$data['id'].'" style="text-align: right"  type="number">'.number_format($data['unit_price']).'</td>
						...
						$hasil .= 
							...
							'<tr>
								...
								<td colspan="3" rowspan="3" class="catatan-po">'.$cat[0].'</td>
								<td>Sub Total</td>
			...
			<div align="center">
			 	<table class="tab">
				 	...
				 	<tr>
				 		<td style="padding-top: 65px; text-decoration: underline;">'.$rdata['created_po'].'</td>
				 		<td style="padding-top: 65px; text-decoration: underline;">Nugrah Reza Djannatin</td>
