...
<form class="form-horizontal" id="manifest_driver" action="javascript:">
	...
	<div class="col-md-6 hidden" id="satu">
		...
		if($rdriver['keterangan']=="kotor") {
			...
			$sql = $con->query("SELECT b.no_nota FROM manifest a,reception b WHERE a.no_nota=b.no_nota AND kd_serah3='' AND packing=true AND b.kembali=false AND b.tgl_so='0000-00-00 00:00:00'");
		}
