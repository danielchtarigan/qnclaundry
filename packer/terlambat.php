...
<script type="text/javascript">
	...
	<div class="table-responsive" style="margin-top: 25px">
		<legend align="center" ><marquee behavior=alternate  width="800">Kiloan Belum Packing</marquee></legend>
		...
		<table class="table table-striped" style="font-size: 11px" id="dataall">
			...
			<tbody>
				...
				$sql = $con-> query("SELECT a.tgl_input, a.spk, a.no_nota, a.jenis,a.nama_customer,a.total_bayar,a.tgl_cuci,a.tgl_setrika,a.tgl_packing,timediff('$jam',a.tgl_input) as waktu,a.tgl_workshop,a.op_workshop, a.op_cuci, a.user_setrika, a.user_packing, a.tgl_spk, rcp_spk FROM reception a, outlet b WHERE a.nama_outlet=b.nama_outlet AND a.workshop='$workshop' AND a.jenis='k' AND a.kembali=false AND a.tgl_so='0000-00-00 00:00:00' AND a.rijeck=false AND a.packing=false AND a.cara_bayar<>'Void' AND a.cara_bayar<>'Reject' AND b.Kota='Makassar' AND status_order='' ORDER by a.tgl_input DESC");
	...
	<div class="table-responsive">
		<legend align="center" style="margin-top: 25px"><marquee behavior=alternate  width="800">Potongan Belum Packing</marquee></legend>
		...
		<table class="table table-striped" style="font-size: 11px" id="dataallpotongan">
			...
			<tbody>
				...
				$sql = $con-> query("SELECT a.tgl_input, a.spk, a.no_nota, a.jenis,a.nama_customer,a.total_bayar,a.tgl_cuci,a.tgl_setrika,a.tgl_packing,timediff('$jam',a.tgl_input) as waktu,a.tgl_workshop,a.op_workshop, a.op_cuci, a.user_setrika, a.user_packing, a.tgl_spk, rcp_spk FROM reception a, outlet b WHERE a.nama_outlet=b.nama_outlet AND a.workshop='$workshop' AND a.jenis='p' AND a.kembali=false AND a.tgl_so='0000-00-00 00:00:00' AND a.rijeck=false AND a.packing=false AND a.cara_bayar<>'Void' AND a.cara_bayar<>'Reject' AND b.Kota='Makassar' ORDER by a.tgl_input DESC");
				while($data = $sql-> fetch_array()){
					$waktus = explode(":",$data['waktu']); 
