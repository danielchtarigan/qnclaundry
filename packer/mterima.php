...
<table width="100%">
  ...
  ?>
    ...
    <form onsubmit="return validasi2()" method="POST" action="act_manifest2.php">
    <table width="100%">
...
//=================================================
  ...
  $tipe=$_POST['tipe'];
?>
<p><input type="text" class="form-control" name="cari" id="cari" onkeypress="handle(event)" placeholder="Scan Kode Manifest Transfer Masuk di sini !" style="width:50%;float:left;"></p>
<table width="100%" >
  <tr><td width="50%">
    <div id="checkboxes">
  <?php
    $cekdata = mysqli_query($con, "select * from man_serah where driver='$driver' and tipe=$tipe and kode_terima='' and tempat<>'$workshop'");
