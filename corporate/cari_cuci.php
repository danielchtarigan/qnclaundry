...
<div  class="container-fluid" style="width:850px;
  ...
  <fieldset>
    <legend align="center"><strong>Cuci Hotel</strong>
    </legend>
    
    <form method="post" action="savecuci_hotel.php" id="formlist" class="form-horizontal">
...
?>
            <tr>
              ...
              <td><span class="col-xs-6">
                ...
                <input type="number" class="easyui-textbox" name="cucian[]" id="cucian[]" required="true" />
              </span></td>
            </tr>
            <?php } ?>
          </tbody>
