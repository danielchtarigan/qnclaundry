...
<div  class="container-fluid"  style="width:500px;
   ...
   color:#000000;
   margin-bottom: 10px; background-color: #d1b8c2">
<marquee behavior=alternate style="font-size: 25px;color: #dfff00"  > <h1>OPERATOR Pengering</h1></marquee>
