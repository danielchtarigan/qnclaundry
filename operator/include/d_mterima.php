...
?>
                        ...
                        <center><strong>DATA MANIFEST TERIMA WORKSHOP</strong></center>
                        </div>
			...
			$kd = $data2['kode'];
			$query = "SELECT * FROM man_terima where tempat='$workshop' and kode_terima like '%MTW".$kd."%' order by tgl limit 10" ;
			...
			while($data = mysqli_fetch_array($tampil)){?>
				<tr>
						...
						<td>
							<a href="cetak_manifest.php?kode=<?=$data['kode_terima']?>" target="_blank">
