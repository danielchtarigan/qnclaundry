...
?>
                        ...
                        <td><strong>DATA MANIFEST TRANSFER KELUAR</strong></td>
			...
			$kd = $data2['kode'];
			$query = "SELECT * FROM man_serah where tempat='$workshop' and kode_serah like '%MTK".$kd."%' order by tgl desc limit 10" ;
			...
			while($data = mysqli_fetch_array($tampil)){?>
				<tr>
						...
						<td>
							<a href="cetak_manifest2.php?kode=<?=$data['kode_serah']?>" target="_blank">
