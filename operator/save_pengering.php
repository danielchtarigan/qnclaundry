...
$q=mysqli_query($con,"insert into pengering (tgl_pengering,op_pengering,no_nota,jumlah,no_mesin) VALUES('$jam','$us','$nt','".$_POST['jumlah1']."','".$_POST['no_mesin']."')");
	 $query="update reception set pengering='1',tgl_cuci='$jam',op_pengering='$us'  WHERE id = '".$_GET['id']."'";
