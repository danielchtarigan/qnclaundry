...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Tables Packing</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
		...
		<tfoot>
            <tr>
                ...
                <th></th>
						...
						<tbody>
				<?php
				$user_query = $mysqli->query("SELECT DATE_FORMAT(packing.tgl_packing, '%Y/%m/%d') as tgl_packing,packing.user_packing as user_packing ,sum(packing.jumlah) as jumlahpacking,count(packing.jumlah) as jumlah, reception.jenis as jenis FROM packing INNER JOIN reception WHERE packing.no_nota=reception.no_nota and reception.user_packing <>'' GROUP BY tgl_packing,jenis,user_packing ORDER BY tgl_packing DESC" )or die(mysqli_error());
		...
		<tbody>
			...
			<?php
			$query =$mysqli->query( "SELECT reception.tgl_packing as tgl_packing,reception.no_nota as no_nota,reception.user_packing as user_packing,reception.jumlah as jumlah,packing.jumlah as jumlahpacking,reception.total_bayar as total_bayar, reception.jenis as jenis FROM packing INNER JOIN reception WHERE packing.no_nota=reception.no_nota and reception.user_packing <>'' ORDER BY tgl_packing DESC" );
			
			while($data =$query->fetch_array()){
			echo "<tr><td>$data[tgl_packing]</td>
						<td>$data[no_nota]</td>
						<td>$data[user_packing]</td>
						<td>$data[jumlah]</td>
						<td>$data[jumlahpacking]</td>
						<td>$data[jenis]</td>
