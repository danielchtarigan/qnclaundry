                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                 ...
                                 <li>
                                    <a href="lap_dokument.php">Dokument</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
...
<th>Rcp ambil</th>
		...
		<tbody>
		<?php
			$query = $mysqli->query("SELECT id,no_nota,tgl_input,tgl_spk,tgl_kembali,tgl_so,nama_outlet,nama_customer,tgl_ambil,reception_ambil FROM reception ORDER BY tgl_input DESC") ;
