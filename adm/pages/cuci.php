    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="pemasukan.php">Kas Masuk</a>
                                </li>
                                <li>
                                    <a href="omset.php">Omset</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
		...
		<tfoot>
            <tr>
				...
				<tbody>
				<?php
				$user_query = $mysqli->query("SELECT DATE_FORMAT(cuci.tgl_cuci, '%Y/%m/%d') as tgl_cuci,cuci.op_cuci as op_cuci ,sum(cuci.jumlah) as jumlahcuci,count(cuci.jumlah) as jumlah, reception.jenis as jenis FROM cuci INNER JOIN reception WHERE cuci.no_nota=reception.no_nota and reception.op_cuci <>'' GROUP BY tgl_cuci,jenis,op_cuci ORDER BY tgl_cuci DESC" )or die(mysqli_error());
		...
		<tbody>
			...
			<?php
			$query =$mysqli->query( "SELECT reception.tgl_cuci as tgl_cuci,reception.no_nota as no_nota,reception.op_cuci as op_cuci,reception.jumlah as jumlah,cuci.jumlah as jumlahcuci,reception.total_bayar as total_bayar, reception.jenis as jenis FROM cuci INNER JOIN reception WHERE cuci.no_nota=reception.no_nota and reception.op_cuci <>'' ORDER BY tgl_cuci DESC" );
