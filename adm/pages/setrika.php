...
<body>
    ...
    <div id="wrapper">
		...
		<tbody>
			...
			<?php
			$query =$mysqli->query("SELECT reception.tgl_setrika as tgl_setrika,reception.no_nota as no_nota,reception.user_setrika as user_setrika,reception.berat as berat,setrika.berat as beratsetrika,reception.total_bayar as total_bayar, reception.jenis as jenis FROM setrika INNER JOIN reception WHERE setrika.no_nota=reception.no_nota and reception.user_setrika <>'' ORDER BY tgl_setrika DESC") ;
			while($data =$query->fetch_array()){
			echo "<tr><td>$data[tgl_setrika]</td>
						<td>$data[no_nota]</td>
						<td>$data[user_setrika]</td>
						<td>$data[berat]</td>
						<td>$data[beratsetrika]</td>
						<td>$data[jenis]</td>
