...
<legend align="center"><strong>Semua Outlet</strong></legend> 
...
<th>Rcp SO</th>
		...
		<tbody>
			<?php
			$query = "SELECT tgl_input,no_nota,nama_customer,tgl_workshop,tgl_cuci,tgl_setrika,tgl_packing,tgl_kembali,reception_kembali,tgl_ambil,reception_ambil,tgl_so,rcp_so FROM reception WHERE (DATE_FORMAT(tgl_input, '%Y-%m-%d') between '$newDate' and '$newDate2') ORDER BY tgl_input" ;
