...
<hr>
        ...
        <legend align="center" ><strong style="color:#85B92E">Pembayaran</strong></legend>
         ...
         <div class="form-group ">
                        ...
                        <input type="text"  class="form-control" readonly="true" value="Auto" autocomplete="off" name="no_faktur" id="no_faktur" required="true">
                        </div></div>
         <div class="form-group">
          ...
          <div class="form-group"> 
                ...
                <option value="edcbni">Edc BNI</option>
...
<script>
 ...
 $("#carabayar").change(function(){
     ...
     var tt= $("#tt").val();
     if(carabayar=="edcbca" || carabayar=="edcmandiri" || carabayar=="edcbri" || carabayar=="edcbni" || carabayar=="kuota"){
	  	$("#by").val("0");
	  	 $("#by").attr("disabled","");
	  }else{
	  	$("#by").val("");
