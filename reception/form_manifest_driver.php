...
<form class="form-horizontal" id="manifest_driver" action="javascript:">
	...
	<div class="col-md-6 hidden" id="satu">
		...
		if($rdriver['keterangan']=="kotor") {
			$query = "SELECT a.no_nota FROM reception a LEFT JOIN manifest b ON a.no_nota = b.no_nota WHERE b.no_nota IS NULL AND a.nama_outlet = '$ot' AND cara_bayar <> 'Void' AND packing = false AND DATE(tgl_input) >= '2019-03-01'";
