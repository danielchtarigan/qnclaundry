...
?>
	 ...
	 $qview = mysqli_query($con, "select * from reception where id_customer='$_GET[id]' and lunas='0'");
	      ...
	      <table style="width:100%;">
	         <tr>
	            <?php
					...
					<a href=struk.php?no_nota='.$no_nota.' target="_blank"><button type=submit class=btn btn-default>Cetak</button></a> <a href=batal_order.php?no_nota='.$no_nota.'><button type=submit class=btn btn-default>Batal</button></a>
					</td>
					</tr>';
