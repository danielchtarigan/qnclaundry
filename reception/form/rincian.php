...
<?php
			...
			<?php
            $qretail = mysqli_query($con, "select *, count(*) as tot from detail_retail a, retail b where a.item=b.kode and a.no_nota='$no_nota'");
...
echo str_replace('Rp.','',rupiah($total+$totalretail+$rexpress, true));
				?>				</td>
                                <td></td>
			</tr>
<?php
