...
<script type="text/javascript">
 ...
 location.href="../index.php?id=<?php echo $id_cs; ?>&jenis=<?php echo $_GET['jenis']; ?>&status=<?php echo $_GET['status']; ?>&nota=<?php echo $no_nota;?>#popup11";
</script>
<?php
		}
	 else{
...
<script type="text/javascript">
 alert("Data telah terinput!");
 location.href="../index.php?id=<?php echo $id_cs; ?>&jenis=<?php echo $_GET['jenis']; ?>&nota=<?php echo $no_nota;?>#popup11";
</script>
<?php
	 }
	 ?>