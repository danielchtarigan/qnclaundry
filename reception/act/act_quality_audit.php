...
if ($ncek<1){
	$q="insert into quality_audit(tgl_input,user_input,no_nota,bersih,harum,rapi,jumlah,waktu,ket,nama_customer,no_qa) VALUES('$jam','$us','$no_nota','$kebersihan','$keharuman','$kerapian','$jumlah','$waktu','$kritik','$nama_customer','$nextNoTransaksi')";
