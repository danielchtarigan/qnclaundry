                                                   ...
                                                   <select name="itemklp" id="itemklp" class="form-control" onchange="itemxx()">
													...
													while($ritem = mysqli_fetch_array($qitem)){							
															...
															<?php
																...
																elseif($r['type_c']==1 and $r['type_d']==0 and ($ot=='Landak' or $ot='Baruga')){
																	?>
															 <option value="<?php echo $ritem['nama_item']."-".$ritem['harga_c']; ?>"><?php echo $ritem['nama_item']; ?></option>
															<?php
																}
																elseif($r['type_d']==1 and $r['type_c']==0 and ($ot=='BTP' or $ot='DAYA')){
																	?>
															 <option value="<?php echo $ritem['nama_item']."-".$ritem['harga_d']; ?>"><?php echo $ritem['nama_item']; ?></option>
															<?php
																}
																else{
															?>
                                                ...
                                                <div class="col-xs-9" >
												   ...
												   <option value=""></option>
                                                    ...
                                                    <?php
														...
														elseif ($r['lgn']==1){
													?>
                                                     <option value="<?php echo $ritem['nama_item']."-".$ritem['harga']*0.8; ?>"><?php echo $ritem['nama_item']; ?></option>
                                                    <?php
														}
														else{
													?>
...
<div class="popup-wrapper" id="popup13">
	<div class="popup-container">
                                ...
                                <form method="GET" action="act/act_deposit.php" id="form-input1" class="form-horizontal" target="_blank">
                                ...
                                <div class="modal-footer">
										<input type="submit" class="btn btn-success btkiloan" value="Simpan" style="width:49%; background-color:#FFF; color:#6C0;"/>
										<a href="index.php?id=<?php echo $_GET['id'];?>" class="popup-link">
                                        <input type="button" class="btn btn-success btpotongan" value="Selesai" style="width:49%; background-color:#FFF; color:#6C0"/>
                                        </a>
                                </div>
                                        </form>
...
<div class="popup-wrapper" id="popup14">
	<div class="popup-container">
                                ...
                                <div class="modal-body" width="100%">
                                        <form method="GET" action="act/act_member.php" id="form-input1" class="form-horizontal" target="_blank">
                                ...
                                <div class="modal-footer">
                                        <input type="submit" id="simpanmember" class="btn btn-success btpotongan" style="width:49%; background-color:#FFF; color:#6C0" value="Simpanh"/>
                                        <a href="index.php?id=<?php echo $_GET['id'];?>" class="popup-link">
                                         <input type="button" class="btn btn-success btpotongan" value="Batal" style="width:49%; background-color:#FFF; color:#6C0"/>
                                        </a>
                                </div>
...
<?php
	  ...
	  ?>
                                        <a href="index.php?id=<?php echo $_GET['id'];?>" onclick="window.open('struk.php?id=<?php echo $_GET['id'];?>&no_nota=<?php  echo $no_nota; ?>')">
