...
?>
   ...
   color:#000000;
   margin-bottom: 10px;">
   <marquee behavior=alternate style="font-size: 25px;color: #ff0000"  > <h1>Cari Outlet</h1></marquee>
		<form method="post" action="view_outlet.php" target="_blank" id="form-input" class="form-horizontal">
