...
?>
   ...
   color:#000000;
   margin-bottom: 10px;">
   <marquee behavior=alternate style="font-size: 25px;color: #ff0000"  > <h1>Cari Lap Tutup Kasir</h1></marquee>
		<form method="post" action="lap_tutup_kasir.php" target="_blank" id="form-input" class="form-horizontal">
