...
if (isset($_SESSION['level']))
{
   ...
   if ($_SESSION['jenis']!='dispatcher') header('location: index.php');
}
				...
				$.ajax({
					...
					success: function(result){
						...
						if(resultjson.status == "yes"){
							...
							$('#nogetfaktur').text(
								"Mohon cek kembali nomor faktur atau nomor nota yang dimasukkan\n.Pencarian berdasarkan nomor nota hanya bisa dilakukan untuk sub agen dan belum lunas"
							);
