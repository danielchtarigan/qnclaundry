...
if ($ncek>0){
$qrincian2 = mysqli_query($con, "DELETE from order_tmp where id_customer = '$id' AND cabang<>'Delivery' ");
...
mysqli_query($con, "INSERT INTO kategori_item_order VALUES ('$no_nota','k','$kat','$jam1')");
