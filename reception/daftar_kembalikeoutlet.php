...
?>
   ...
   color:#000000;
   margin-bottom: 10px;">
   <marquee behavior=alternate style="font-size: 25px;color: #ff0000"  > <h1>sms berdasar tgl_kembali</h1></marquee>
		<form method="post" action="" id="form-input" class="form-horizontal">
		
	
		<div class="form-group"> 
     	<label class="control-label col-xs-3" for="setrika">Pilih Tanggal Kembali</label>
	 <div class="col-xs-5" >
...
<textarea id="pesan_kirim"></textarea>
	</div>
