...
<?php
$cek = mysqli_query($con, "select * from customer where id='$id'");											
...
<table style="width:100%;border-top: 1px dashed #000;border-bottom: 1px dashed #000; font-family: Tahoma;text-align: justify;">
    <tr style="font-size: 7pt;">
        <td align="center" colspan="4">
            SELAMAT! ANDA MENDAPATKAN VOUCHER <?php echo $voucher ; ?>. TUKARKAN POTONGAN KUPON INI PADA RESEPSIONIS DISELURUH OUTLET QUICK N CLEAN LAUNDRY
        </td>
    </tr>
</table>
<?php
