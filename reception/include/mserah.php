...
<h3 align="center">MANIFEST SERAH WORKSHOP</h3>
<p><input type="text" class="form-control" name="cari" id="cari" onkeypress="handle(event)" placeholder="Scan No Nota di sini !"></p>
<table width="100%">
  <tr><td width="50%">
    <div id="checkboxes">
  <?php
  $cekdata = mysqli_query($con, "select * from manifest a,reception b where a.no_nota=b.no_nota and workshop='' and outlet='$ot' and kd_serah='' and rijeck=0 and spk=1");
  if ($cekdata){
    $i=0;
