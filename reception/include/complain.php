...
<div  class="container-fluid" style="width:500px;
   ...
   margin-bottom: 10px;
   ">
<marquee behavior=alternate style="font-size: 25px;color: #ff0000"  > <h1>Form Komplain</h1></marquee>
		<p>Syarat komplain : tanggal pengambilan tidak boleh lebih dari 3 hari</p>
		<label class="control-label col-xs-3" for="cari">Cari no nota</label><div class="col-xs-4">
  		<input  placeholder="nomer nota" class="form-control" autocomplete="off" type="text" name="cari" id="cari" ></div><br>
