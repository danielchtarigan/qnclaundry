<?php
include "laporan_setoran_bank2.php";
?>
			...
			$query = "SELECT * FROM reception where nama_outlet='$outlet' and kembali=false and express=true ORDER BY tgl_input desc limit 0,10" ;
