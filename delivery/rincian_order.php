...
$delete = mysqli_query($con, "DELETE FROM order_tmp WHERE no_nota='$no_nota'");
...
if(!isset($_GET['show'])) {
	...
	<table>
		<tr>
			<!--<td style="padding-right: 10px"><a href="#" class="btn btn-danger btn-batal" disabled="true"> Batal</i></a></td>-->
			<!--<td style="padding-right: 10px"><a href="#" class="btn btn-info btn-back4"><span class="glyphicon glyphicon-step-backward" disabled="true"></span> Kembali</a></td>			-->
			<td><a href="#" id="cetak_order" class="btn btn-primary"> Simpan Order</i></a></td>
		</tr>
	</table>
	<?php
}
...
<script type="text/javascript">
	...
	$('#cetak_order').on('click', function(){			
		...
		$.ajax({
			url 	: 'cetak_order.php',
			data 	: 'nota='+nota+'&idcst='+idcst+'&outlet='+outlet+'&total='+tot,
