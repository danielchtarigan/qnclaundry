...
<div class="col-md-4 col-md-offset-0" >
	<table id="dg" title="Inventory" class="easyui-datagrid" style="width:700px;height:250px"
		...
		<thead>
			<tr>
				<th field="kode_item" width="50">Kode Item</th>
				<th field="nama_item" width="50">Nama Item</th>
				<th field="penanggung_jawab" width="50">Penaggung jawab</th>
				<th field="tanggal" width="50">Tanggal Update</th>
			</tr>
		</thead>
	</table>
	<div id="toolbar">
	...
	<div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
			<div class="fitem">
				<label>Kode:</label>
				<input name="kode_item" class="easyui-textbox" required="true">
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				...
				<input name="penanggung_jawab" class="easyui-textbox" required="true">
			</div>
	...
	<script type="text/javascript">
		...
		function editUser(){
			...
			if (row){
				...
				$('#fm').form('load',row);
				url = 'edit_inventory.php?id='+row.id;
			}
		}
		function saveUser(){
			$('#fm').form('submit',{
