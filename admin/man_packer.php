...
<fieldset>
<legend align="center"><strong>Cek Manifest Serah Packer</strong></legend> 
<table id="man_pack" class="display">
		...
		<tbody>
		<?php $sql = $con->query("select a.no_nota,b.pemberi,a.kd_serah3,a.outlet,b.tgl,b.driver from manifest a join man_serah b on a.kd_serah3=b.kode_serah"); ?>
...
<fieldset>
<legend align="center"><strong>Cek Terima Setrika DAYA</strong></legend> 
<table id="terima_pack" class="display">
		...
		<tbody>
		<?php $sql = $con->query("select a.no_nota,a.outlet,a.kd_terima2,b.tgl,b.penerima,b.driver from manifest a join man_terima b on a.kd_terima2=b.kode_terima"); ?>
			
					<?php while ( $data = $sql->fetch_assoc() ) { ?>
					<tr>
						<td><?php echo $data['tgl']?></td>
						<td><?php echo $data['kd_terima2']?></td>
