                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" style="font-size:9px;">
                                    ...
                                    <?php
										...
										for($no; $no>1; $no--){
											$tanggal = $tahun.'-'.$bulan.'-'.sprintf('%02s', $no);
												$q1 = mysqli_query($con, "select * from outlet where nama_outlet='$outlet'");
									...
									?>
                                        <tr class="odd gradeX">
                                            ...
                                            if ($sesuai==0){
                                            ?>
                                            <a href="index.php?menu=penyesuaian&ids=<?php echo $ids; ?>" onClick="return confirm('Apakah anda telah mengecek mutasi bank?')" ><button type="button" class="btn btn-primary btn-xs" style="background-color:#F00; border-color:#F00;" id="test" name="test">Proses</button></a>
                                            <?php
                                            }
                                            else{
                                            	echo rupiah($sesuai);
											...
											?>
                                            <a href="act/act_verifikasi.php?id=<?php echo $ids; ?>" onClick="return confirm('Apakah anda telah mengecek mutasi bank?')" ><button type="button" class="btn btn-primary btn-xs" style="background-color:#666666; border-color:#666666;" id="test" name="test">Proses</button></a>
											<?php
											} 
											else{
											?>
