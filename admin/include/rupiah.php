			...
			<form  action="act/voucher_rupiah.php" method="post" class="form-horizontal">
				<br>
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<?php
						$query5           = "SELECT max(right(kode,4)) AS last FROM voucher_rupiah order by kode desc LIMIT 1";
				...
				<div class="form-group">
					<label for="no_nota" class="control-label col-xs-3">
						<p align="left">Nilai Voucher</p>
					</label>
					<div class="col-xs-4">
						<input type="text" placeholder="nilai voucher" id="nilai" name="nilai" class="form-control" required>								
					</div>
				</div>
