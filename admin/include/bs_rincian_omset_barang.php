...
<div class="row">
	<div class="col-lg-6">
		<h4>Penjualan Barang Per Faktur</h4>
	</div>
	<div class="col-lg-6" align="right">
		<button class="btn btn-primary">Rincian Barang</button>
		<button class="btn btn-primary">Rincian Barang Per Outlet</button>
	</div>
</div>
<hr>
<div class="table-responsive" style="overflow-x:auto">
	<table class="table table-bordered table-striped table-condensed result" id="result">
		<thead>
            <tr>
				<th>Tanggal</th>
				<th>Nama Outlet</th>
...
<script type="text/javascript">
	jQuery(function($){
		...
		$('.jaringan').submit(function(e){
			...
			$.ajax({
				url			: 'include/bs_details_sales_goods.php',
