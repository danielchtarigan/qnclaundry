				...
				"columns": [
                    ...
                    { "data": null, "orderable": false, "searchable": false, render: function (data, type, row) {
                        if (row.category == "Kiloan") {
                            ...
                            return "<button class='btn btn-info btn-xs' align='center' id='editgoods' data-id='"+ row.price_id +"'>Edit</button>";
                        }
                    }, },
                ],
       ...
       // get detail branch outlet
        ...
        $(document).on("click", ".modal .modal-footer #savegoods", function () {     
            ...
            if (modal == "Custom Harga") {
                ...
                let priceId = $(".modal .modal-title").attr("data-goods");
    
                if (valid) {
                    let url = (priceId != "" && goods_id > 0) ? "Items/update/"+priceId : "Items/store";
                    saveForm(data, url);
                    $(".modal").modal("hide");
                }
            }
