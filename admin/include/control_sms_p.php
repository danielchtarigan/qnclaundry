...
<div class="col-md-12 col-md-offset-0" id="hasil">
	...
	<form class="form-horizontal">			
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Max Kunjungan</p></label>
			<div class="col-md-3">					
				<input class="form-control" type="text" name="" id="frek" value="3" placeholder="Maksimal berkunjung">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Range Awal</p></label>
			<div class="col-md-3">
				<input class="form-control" type="text" name="" id="start" placeholder="Dimulai Dari Tanggal">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Range Akhir</p></label>
			<div class="col-md-3">
				<input class="form-control" type="text" name="" id="end" placeholder="Sampai Tanggal">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Min Transaksi</p></label>
			<div class="col-md-3">
				<input class="form-control" type="text" name="" id="min" value="0">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Max Transaksi</p></label>
			<div class="col-md-3">
				<input class="form-control" type="text" name="" id="max" value="0">
			</div>
		</div>
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Jenis Item</p></label>
			<div class="col-md-3">
		...
		<div class="form-group">
			<label class="control-label col-md-2"><p class="pull-left">Jam SMS</p></label>
			<div class="col-md-3">
		...
		<div class="form-group">
			<div class="col-md-3 col-md-offset-2"><input class="btn btn-md btn-success" type="submit" name="" value="Cari Data"></div>			
		</div>
