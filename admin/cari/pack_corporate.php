				...
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					...
					<div class="modal-body">
						<h4>Pencarian Tanggal</h4>
							<form class="form-inline" method="post" action="pack_corporate.php">
...
?>
				...
				<div class="col-lg-12 col-md-offset-0">
					<div class="panel panel-default">
						<div class="panel-heading"><strong>Packed Corporate Hari ini</strong></div>
								...
								<div class="table-responsive">
									<table class="table table-condensed table-stripped" id="order">
										...
										<?php
												...
												$ord = mysqli_query($con, "select DATE_FORMAT(created, '%Y/%m/%d') as tgl,packing_number,id,id_hotel,creator_id from corp_packing_list where id_hotel='$rq1[id]' and creator_id='$ropr[id]' and DATE_FORMAT(created, '%Y/%m/%d')='$tl' order by created");							
