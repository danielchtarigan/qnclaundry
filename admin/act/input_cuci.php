...
if(isset($_POST['submit'])){
	...
	$qcuci = mysqli_query($con, "select *from cuci where no_nota='$nota' ");
	if (mysqli_num_rows($qcuci)>0) {?>
		...
		$query = mysqli_query($con, "update reception set cuci='1', tgl_cuci='$tanggala', op_cuci='$opr' where no_nota='$nota' ");
		$query2 = mysqli_query($con, "insert into cuci (tgl_cuci,op_cuci,no_nota,jumlah,no_mesin,ket) VALUES('$tanggala','$opr','$nota','$jumlah','','admin654321')");
...
<div  class="container-fluid" style="width:400px; margin:0 auto; position:relative; border:3px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); color:#000000; margin-bottom: 10px; margin-top: 70px;">
   	<fieldset><legend align="center"><strong>Input Cuci</strong></legend>
		 	...
		 	<div class="col-sm-12 col-xs-12">
				<form class="form-horizontal" action="" method="post">
					...
					<div class="form-group">
						<label class="control-label col-sm-4 col-xs-4">Tanggal Cuci</label>
						<div class="col-sm-8 col-xs-8">
