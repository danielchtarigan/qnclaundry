...
dom: 'T<"clear">lfrtip',
	    ...
	    {column_number : 3},	    {column_number : 6}
...
<fieldset>
<legend align="center"><strong>Manifest Transfer Setrika</strong></legend> 
<table id="setrika" class="display">
		...
		<tbody>
		<?php $sql = $con->query("select a.no_nota,a.kd_terima2,b.kode_serah,b.tgl,b.pemberi,b.driver from manifest a join man_serah b on a.kd_serah2=b.kode_serah"); ?>
					...
					<tr>
						...
						<td><?php 
				$sql2 = mysqli_query($con, "SELECT kode_terima,penerima FROM man_terima WHERE kode_terima='$data[kd_terima2]'");
