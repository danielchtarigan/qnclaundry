...
<table id="cuci" class="display">
		...
		<tbody>
			<?php
			$query = "SELECT nama_outlet,DATE_FORMAT(tgl_input, '%Y-%m-%d') as tgl_input,sum(total_bayar) as jumlah,nama_reception FROM reception WHERE (DATE_FORMAT(tgl_input, '%Y-%m-%d') between '$newDate' and '$newDate2') AND cara_bayar<>'Void' AND cara_bayar<>'Reject' group by nama_reception,nama_outlet,DATE_FORMAT(tgl_input, '%Y%m%d') ORDER BY tgl_input ASC" ;
...
<table id="rincian" class="display">
	<thead>
		...
		<tbody>
			<?php
			$query = "SELECT jenis,nama_outlet,tgl_input,no_nota,id_customer,nama_customer,no_faktur,total_bayar,voucher,diskon,nama_reception,cabang,cara_bayar,lunas FROM reception WHERE (DATE_FORMAT(tgl_input, '%Y-%m-%d') between '$newDate' and '$newDate2') AND cara_bayar<>'Void' AND cara_bayar<>'Reject' ";
			$tampil = mysqli_query($con, $query);
