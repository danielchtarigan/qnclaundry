...
<fieldset>
<legend align="center"><strong>Manifest ke Outlet</strong></legend> 
<table id="bersih" class="display">
		<thead>
		<tr>			
			<th>Tanggal Kirim</th>
			<th>Ke Outlet</th>
		...
		<tbody>
		<?php $sql = $con->query("SELECT a.no_nota,a.kd_terima3,b.kode_serah,b.tgl,b.tempat,b.pemberi,b.driver from manifest a join man_serah b on a.kd_serah3=b.kode_serah WHERE DATE_FORMAT(b.tgl, '%Y-%m-%d') BETWEEN '$startDate' AND '$endDate' ORDER BY tgl desc"); ?>
					...
					<tr>
						...
						<td><?php 
				$sql2 = mysqli_query($con, "SELECT tgl,kode_terima,penerima FROM man_terima WHERE kode_terima='$data[kd_terima3]'");
