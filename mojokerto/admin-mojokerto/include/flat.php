<?php
if (isset($_GET['kode'])){
$qcustomer = mysqli_query($con, "select * from mjk_promo_flat where kode='$_GET[kode]'");
...
?>
			...
			<form  action="p_kode_flat.php" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
                        <?php 
						$hari1 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Monday%'");
						...
						$hari2 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Tuesday%'");
						...
						$hari3 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Wednesday%'");
						...
						$hari4 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Thursday%'");
						...
						$hari5 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Friday%'");
						...
						$hari6 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Saturday%'");
						...
						$hari7 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and hari like '%Sunday%'");
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
<?php
						$bayar1 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and pembayaran like '%Cash%'");
						...
						$bayar2 = mysqli_query($con, "select * from mjk_promo_flat where kode='$rcustomer[kode]' and pembayaran like '%EDC%'");
...
?>
			...
			<form  action="p_kode_flat.php" method="post" class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" value="" id="kode" name="kode" placeholder='exp. FLAT7000' class="form-control" required="required">
					</div>
				</div>
				<div class="form-group">
					<label for="no_nota" class="control-label col-xs-3" >
				...
				<div class="form-group">
					...
					<div class="col-xs-4">
						<input type="text" value="" id="flat" name="flat" placeholder='Harga Flat (exp. 7000)' class="form-control" required="required">
					</div>
				</div>
				<div class="form-group">
					<label for="no_nota" class="control-label col-xs-3" align="left">
					...
					<div class="col-xs-4">
						<input type="text" id="minimum_berat" name="minimum_berat" class="form-control"  value="" placeholder="exp. 2" required="required">
					</div>
				</div>
				<div class="form-group">
					<label for="no_nota" class="control-label col-xs-3" align="left">
					...
					<div class="col-xs-4">
						<input type="text" id="maksimum_berat" name="maksimum_berat" class="form-control"  value="" placeholder="exp. 5" required="required">
					</div>
				</div>
				<div class="form-group">
					<label for="no_nota" class="control-label col-xs-3" align="left">
