...
mysqli_query($con,"delete from mjk_kode_promo where kode='$kode'");
mysqli_query($con,"insert into mjk_kode_promo values ('', '$kode','$kategori','$outlet','$diskon', '$minimum_transaksi', '$maksimum_transaksi', '$hari', '$syarat', '$pembayaran', '$hariini', '$_SESSION[name]', 'Aktif')");
}
}
?>
<script type="text/javascript">
