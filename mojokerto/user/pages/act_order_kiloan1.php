...
$nama_customer = $rcus['nama_customer'];
 ...
 $qrincian5 = mysqli_query($con, "insert into cris_icon_details values ('', '$jam1', '$_SESSION[name]', '$no_nota', '$noso', 'off', '' , '', '', '0', '0', '$no_nota')");	
...
$qrincian2 = mysqli_query($con, "insert into detail_penjualan values ('', '$jam1', '$rharga[nama_item]', '$harga', '1', '$harga', '$no_nota' , '$id', '$rharga[berat]', '$ket1')");
 ...
 $qrincian6 = mysqli_query($con,"insert into reception(new_nota, nama_outlet,nama_reception,tgl_input,nama_customer,no_nota,jenis,express,no_so,id_customer,total_bayar,cabang,ket,berat,voucher,diskon) VALUES('$new_nota', '$ot', '$_SESSION[name]', '$jam1', '$nama_customer', '$no_nota', 'k', '', '$noso', '$id', '', '', '', '$rharga[berat]', '','','')");

if ($qrincian2){
?>
<script type="text/javascript">
 location.href="transaksi.php?id=<?php echo $id; ?>&jenis=<?php echo $_GET['jenis']; ?>&nota=<?php echo $no_nota; ?>#popup4";
</script>
<?php
}
else{
