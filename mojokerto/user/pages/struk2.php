	...
	<div align="center"><?php echo bar128(stripslashes($new_nota)); ?><br><?php echo $no_nota; ?></div>
     ...
     <table style="border-top: 1px dotted #000;width:100%;">
         <tr>
             ...
             <td>
                 <span style="float:right;font-size: 9pt;">Kasir : <?php $_SESSION['name']; ?></span>
             </td>
         </tr>
     </table>     
 ...
 <div>
     ...
     <table style="border-top: 1px dotted #000;width:100%;">
         <tr>
             ...
             <td>
                 <span style="float:right;font-size: 9pt;">Kasir : <?= $_SESSION['name']; ?></span>
             </td>
         </tr>
     </table>     
     <table style="font-size:9pt;border-top: 1px dotted #000;width:100%;">
                          ...
                          <td style="width:33.33%">
                              <h1 style="margin:0px;">
                                  ...
                                  <?php
									...
									}elseif($dita['nama_outlet']=="mojokerto"){
                                        echo "MJK";
                                    }
                                  ?>
                                      </center>
