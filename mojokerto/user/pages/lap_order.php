...
<th>Rcp SO</th>
		...
		<tbody>
			<?php
			$query =$mysqli->query( "SELECT tgl_input,no_nota,nama_customer,tgl_cuci,tgl_setrika,tgl_packing,tgl_kembali,reception_kembali,tgl_ambil,reception_ambil,tgl_so,rcp_so FROM reception where nama_outlet='mojokerto' ORDER BY tgl_input") ;
