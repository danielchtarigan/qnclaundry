...
$qcus = mysqli_query($con, "insert into customer (id, nama_customer, no_telp, alamat, tgl_input, info_dari, user_input, referensi) values ('', '$_GET[nama]', '$_GET[telepon]' , '$_GET[alamat]', '$jam1', '$_GET[info]', '$us', '$referensi')");
 if ($qcus){
?>
<script type="text/javascript">
