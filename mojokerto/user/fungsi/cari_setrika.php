...
if ( $row != 0 ) {
    ...
    <script>
  	...
  	<input type="text" class="form-control" name="jumlah" id="jumlah" required="true" value="<?php echo $data['jumlah']; ?>" readonly="true" ></div>
		...
		<div class="form-group">
  	<label class="control-label col-xs-3" for="nama">Berat</label><div class="col-xs-4">
  	<input type="text" class="form-control" name="berat" id="berat" required="true" ></div>
  		</div>
