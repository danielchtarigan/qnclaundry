...
$r = $sql5->fetch_assoc();
  $t=$r['total'];  
    ...
    $tambah=mysqli_query($con," update reception set tgl_spk_edit='$jam',rcp_spk_edit='$us',jumlah='$t' WHERE no_nota='$no_nota'");
...
echo "<div class='post_title'></div>
      ...
      <tr><td col>
      <br/>
	<font size=2>Tgl $jam			Rcp :$_SESSION[name]</td></tr> </font>";
