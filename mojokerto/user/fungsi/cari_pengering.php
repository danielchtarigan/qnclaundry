...
$sql = mysqli_query($con,"SELECT * From reception where no_nota = '$cari' and pengering=false LIMIT 1");
...
if ( $row != 0 ) {
    ...
    if(jumlah1 == '' || no_mesin == ''){
		alert("Tolong Jumlah sama no mesin di isi");
		exit();
	}
	if(jumlah1 != jumlah ){
...
echo 'pengering :'.$data1['op_pengering']."<br>";
echo 'tgl Kering :'.$data1['tgl_pengering'];
